...
$stmt = $db->prepare("
    ...
    AND l.id_commercant = ?
");
$stmt->execute([$paiement_id, $id_commercant]);
$paiement = $stmt->fetch();

if (!$paiement) {
    die('Paiement introuvable ou non autorisé');
}
...
<body>
    ...
    <div class="no-print" style="text-align: right; margin-bottom: 20px;">
        ...
        <a href="dashboard.php#tab-locations" style="margin-left: 10px; background: #6b7280; color: white; padding: 12px 20px; border-radius: 8px; text-decoration: none; display: inline-block;">
            Retour
        </a>
    </div>
    <?php endif; ?>
    ...
    <div class="info-grid">
        ...
        <div class="info-item">
            ...
            <div class="value"><?= htmlspecialchars($paiement['secteur_nom'] ?? 'Non défini') ?></div>
        </div>
        <div class="info-item">
